    ...
    <div class="comment" data-id="' . $comment['id'] . '" id="comment-' . $comment['id'] . '">
        ...
        <div class="con' . (isset($comment['highlighted']) ? ' highlighted' : '') . '">
            ...
            <div class="comment-footer">
                ...
                ' . (isset($_SESSION['comment_account_loggedin']) && $_SESSION['comment_account_role'] == 'Admin' ? '<a class="moderate-comment-btn" href="admin/comment.php?id=' . $comment['id'] . '" target="_blank">Moderate</a>' : '') . '    
